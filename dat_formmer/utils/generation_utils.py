...
from dat_formmer.utils.utils import Hypothesis, ce_loss, to_tgt_output
...
class DecodeModel(L.LightningModule):
    @abstractmethod
    def transform(
        ...
        while cur_len < max_len and not beam_scorer.is_done():
            ...
            if cur_len == 1:
                ...
                for i in range(len(src)):
                    ...
                    src[i] = repeat(src[i], "l b d -> l (b m) d", m=beam_size)
